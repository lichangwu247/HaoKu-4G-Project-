...
{
    list_t *self;
    if (NULL == (self = malloc(sizeof(list_t))))
        return NULL;
    self->head = NULL;
    self->tail = NULL;
    self->free = NULL;
...
list_node_t *list_find(list_t *self, void *val)
{
    ...
    while (NULL != (node = list_iterator_next(it)))
    {
        if (self->match)
        {
...
list_iterator_t *list_iterator_new_from_node(list_node_t *node, list_direction_t direction)
{
    ...
    if (NULL == (self = malloc(sizeof(list_iterator_t))))
        return NULL;
    self->next = node;
...
{
    list_node_t *self;
    if (NULL == (self = malloc(sizeof(list_node_t))))
        return NULL;
    self->prev = NULL;
    self->next = NULL;
    self->val = val;
